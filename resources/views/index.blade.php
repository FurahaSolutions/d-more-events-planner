...
<head>
    <title>Marry Off Wedding Category Bootstrap Responsive Website Template | Home </title>
    <!-- Meta-Tags -->
...
<div class="banner" id="home">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="index.html">D-more E-Planner</a>
            ...
            <div class="col-lg-6 about-w3ls-right">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <i class="fas fa-share"></i> Collect & organize ideas
                    </li>
                    <li class="list-group-item">
                        <i class="fas fa-share"></i> Connect to vendors
                    </li>
                    <li class="list-group-item">
                        <i class="fas fa-share"></i> Get wedding tips
                    </li>
                    <li class="list-group-item active text-white">Collect & organize ideas</li>
                    <li class="list-group-item">
                        <i class="fas fa-share"></i> Organize wedding planning
                    </li>
                    <li class="list-group-item">
                        <i class="fas fa-share"></i> Customize categories
                    </li>
                    <li class="list-group-item">
                        <i class="fas fa-share"></i>All your favorites in one place
                    </li>
                    <li class="list-group-item active text-white">Registries</li>
                    <li class="list-group-item">
                        <i class="fas fa-share"></i> Add registries to your wedding website
                    </li>
                    <li class="list-group-item">
                        <i class="fas fa-share"></i> Find unique registry gift ideas
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="services-grids row">
            ...
            <div class="col-lg-6 services-info top-services p-xl-5 p-4">
                ...
                <p class="paragraph-agileinfo">We offer great variety of services & programs. Our clients and our
                    experience proves that the following services can
                    literally change your life!</p>
                <ul>
                    <li class="mt-sm-4 mt-3">
                        <span class="fas fa-check" aria-hidden="true"></span>Wedding Ceremony
                    </li>
                    <li class="mt-sm-4 mt-3">
                        <span class="fas fa-check" aria-hidden="true"></span>Wedding Decoration
                    </li>
                    <li class="mt-sm-4 mt-3">
                        <span class="fas fa-check" aria-hidden="true"></span>Florist Services
                    </li>
                    <li class="mt-sm-4 mt-3">
                        <span class="fas fa-check" aria-hidden="true"></span>Bridal Cortege
                    </li>
                    <li class="mt-sm-4 mt-3">
                        <span class="fas fa-check" aria-hidden="true"></span>Catering Services
                    </li>
                    <li class="mt-sm-4 mt-3">
                        <span class="fas fa-check" aria-hidden="true"></span>Wedding Portfolio
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <ul class="slides">
                        <li>
                            <div class="testimonials_grid">
                                ...
                                <i>United States</i>
                                <p class="paragraph-agileinfo">Maecenas interdum, metus vitae tincidunt porttitor, magna
                                    quam egestas sem, ac scelerisque nisl nibh vel lacus.
