        ...
        <div class="container py-xl-5 py-sm-3">
            ...
            <div class="row inner-sec-w3layouts-agileinfo align-items-center">
                <div class="col-lg-4 grid_info_main">
                    <div class="grid_info">
                        <div class="icon_info text-left p-4">
							<span class="icon">
								<img src="/assets/images/t1.jpg" class="img-fluid" alt="Responsive image">
							</span>
                            <h5>Joseph Fisher</h5>
                            ...
                            <p class="paragraph-agileinfo">Lorem ipsum dolor sit amet,vehicula vel sapien et, feugiat
                                sapien amet.</p>
                        </div>
                    </div>
                    <div class="grid_info second">
                        <div class="icon_info text-left p-4">
							<span class="icon">
								<img src="/assets/images/t2.jpg" class="img-fluid" alt="Responsive image">
							</span>
                            <h5>Alisa Kuper</h5>
                            <ul class="social_list1 my-3">
                                <li>
                ...
                <div class="col-lg-4 grid_info_main mid my-4">
                    <img src="/assets/images/team.jpg" class="img-responsive" alt=" ">
                </div>
                <div class="col-lg-4 grid_info_main">
                    <div class="grid_info">
                        <div class="icon_info text-left p-4">
							<span class="icon">
								<img src="/assets/images/t3.jpg" class="img-fluid" alt="Responsive image">
							</span>
                            <h5>Soli lostek</h5>
                            <ul class="social_list1 my-3">
                                <li>
                    ...
                    <div class="grid_info second">
                        <div class="icon_info text-left p-4">
							<span class="icon">
								<img src="/assets/images/t4.jpg" class="img-fluid" alt="Responsive image">
							</span>
                            <h5>Marine Kelly</h5>
                            <ul class="social_list1 my-3">
                                <li>
